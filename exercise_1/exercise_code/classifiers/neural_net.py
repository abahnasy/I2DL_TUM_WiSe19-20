...
def neuralnetwork_hyperparameter_tuning(X_train, y_train, X_val, y_val):
    ...
    ############################################################################
    # ABAHNASY: Define input size and number of classes
    input_size = 32 * 32 * 3
    num_classes = 10
    # ABAHNASY: tracking values
    best_val = -1
    best_stats = []
    # ABAHNASY: Set a seed for results reproduction
    np.random.seed(0)
    for i in range(20):
        ...
        stats = net.train(X_train, y_train, X_val, y_val,
                    ...
                    learning_rate=lr, learning_rate_decay=0.89,
...
# ABAHNASY: generate random hyperparameters given ranges for each of them
...
# ABAHNASY: get random hyperparameters given arrays of potential values
